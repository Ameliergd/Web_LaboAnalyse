            ...
            <div class="container">
                ...
                <div id="navbarMenu" class="navbar-menu">
                    ...
                    <div class="navbar-start">
                            ...
                            <a class="navbar-item" href="informations.html">INFORMATIONS</a>
                    </div>
                    <div class="navbar-end is-grouped">

                        <div class="navbar-item control">
                            <a class="button is-primary" href="patients.php" target="_blank">
                                  <span class="icon">
        ...
        <div class="columns is-vcentered">
          ...
          <div class="column is-6 is-offset-1">
            ...
            <h2 class="subtitle is-4">
              Le dépistage des maladies est un processus complexe et son efficacité dépend de multiples conditions. C’est le médecin, hospitalier ou ambulatoire, de premier recours ou spécialiste, qui est souvent en première ligne pour affronter cette complexité.
            </h2>
            <br>
...
Une deuxième différence est que les tests de dépistage sont généralement conçus pour s’appliquer qu’aux individus sans symptômes. En revanche, les tests diagnostiques peuvent s’appliquer aux individus avec et sans symptômes.<br/><br/>

Adhérence au programme<br/>
