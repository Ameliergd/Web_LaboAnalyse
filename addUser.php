              ...
              <div class="field-body">
                <div class="field">
                  <p class="control is-expanded has-icons-left">
                    ...
                    <span class="icon is-left"><i class="fa fa-envelope" aria-hidden="true"></i>
</span>
                  </p>
                </div>
              </div>
              ...
              <div class="field-body">
                <div class="field">
                  <p class="control is-expanded has-icons-left">
                    ...
                    <span class="icon is-left"><i class="fa fa-key" aria-hidden="true"></i>
</span>
                  </p>
                </div>
              </div>
              ...
              <div class="field-body">
                <div class="field">
                  <p class="control has-icons-left">
                    ...
                    <span class="icon is-left"><i class="fa fa-calendar" aria-hidden="true"></i>
</span>
                  </p>
                </div>
              </div>
